...
class Weather {
  constructor(dayObj) {
    ...
    this.forecast = 'A high of ' + dayObj.high_temp + ' degrees celsius, and a Low of ' + dayObj.low_temp + ' degrees celsius with ' + dayObj.weather.description;
  }
}
...
function getWeather(latitude, longitude) {
  ...
  const url = `http://api.weatherbit.io/v2.0/forecast/daily/?key=${process.env.WEATHER_API_KEY}&land=en&lat=${latitude}&lon=${longitude}&days=3`;
